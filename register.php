                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                            ...
                                            <div class="form-group"form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>>
                                                <label class="small mb-1" for="username">Username</label>
                                                <input class="form-control py-4" name="username" type="text"  placeholder="Enter username"value="<?php echo $username; ?>" />
                                            </div>
                                            <div class="form-row <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                                                        ...
                                                        <input class="form-control py-4" name="confirm_password" type="password" placeholder="Confirm password" />
