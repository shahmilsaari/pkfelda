...
/* (mysqli_num_rows($res_u) > 0) {
    ...
    $isteri_ic_error = "Ic Number already exist!";
           ...
           echo "<script> alert('Successful Add Isteri Peneroka.Complete Step 3/6.');
           window.location.href='process4.php';</script>";
           exit();
  	}
  }
?>
...
<div <?php if (isset($isteri_ic_error)): ?> class="form_error" <?php endif ?> >
    ...
    <?php if (isset($isteri_ic_error)): ?>
        ...
        <?php endif ?>
                            ...
                            <button type="button" class="btn btn-primary btn-xs"onclick="window.location.href = 'process5.php';">SKIP</button>
